...
public class AlunoDAO {
	...
	public void atualizarBanco(Aluno aluno) {
		String sql = "UPDATE aluno set nome = " + aluno.getNome() + " WHERE id = " + aluno.getId();
		try {
	...
	public List<Aluno> delAlunoPorId(String idAluno) {

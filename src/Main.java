...
public class Main {
	...
	private static void exibeMenu() {
		...
		System.out.println("4 - Atualiza aluno");
		System.out.println("5 - Delete aluno");
	...
	private static void atualizaAluno() {
		System.out.print("Informe o id do aluno: ");		
		String idBusca = entrada.nextLine();
		System.out.print("Informe o nome correto do aluno: ");		
		String idNovoNome = entrada.nextLine();
		
		Aluno aluno = alunoService.listaAlunoPorId(idBusca);
		aluno.setNome(idNovoNome);

		alunoService.validaNovoNome(aluno);
	...
	private static void deleteAluno() {
		...
		Aluno aluno = alunoService.deleteAlunoPorId(idBusca);	
